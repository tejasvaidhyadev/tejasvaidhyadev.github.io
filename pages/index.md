...
<li><a target="_blank" href="https://www.aclweb.org/anthology/2020.wnut-1.79.pdf">
          ...
          {% include elements/button.html link="https://github.com/Ayushk4/extract_covid_entity" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="https://www.aclweb.org/anthology/2020.wnut-1.79.pdf" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="https://www.aclweb.org/anthology/2020.wnut-1.79.bib" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="https://docs.google.com/presentation/d/13DDY6VSmrVPBddTjWb3rThYRFlRDE_9fi4iyBrhJev4/edit?usp=sharing" text="Slides" style="outline-dark" size="sm"%} {% include elements/button.html link="https://github.com/noisy-text/noisy-text.github.io/blob/master/2020/posters/WNUT2020_91_poster%20-%20Tejas%20vaidhya.pdf" text="Poster" style="outline-dark" size="sm" %} 
...
<li><a target="_blank" href="https://www.aclweb.org/anthology/2020.wnut-1.34.pdf">
          "Domain specific BERT representation for Named Entity Recognition of lab protocol."</a>, Tejas Vaidhya and Ayush Kaushal <br>
           ...
           {% include elements/button.html link="https://github.com/tejasvaidhyadev/W-NUT_2020" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="https://www.aclweb.org/anthology/2020.wnut-1.34.pdf" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="https://www.aclweb.org/anthology/2020.wnut-1.34.bib" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="https://github.com/noisy-text/noisy-text.github.io/blob/master/2020/posters/WNUT2020_92_poster%20-%20Tejas%20vaidhya.pdf" text="Poster" style="outline-dark" size="sm" %}
...
<li><a target="_blank" href="https://arxiv.org/pdf/2101.05494.pdf">
          "Hostility Detection in Hindi leveraging Pre-Trained Language Models"</a>, Ojasv Kamal, Adarsh Kumar, and Tejas Vaidhya <br>
           <b><u>Oral Presentation</u></b> at the Constraint workshop at Advancement Of Artificial Intelligence <br> {% include elements/button.html link="https://github.com/kamalojasv181/Hostility-Detection-in-Hindi-Posts" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="https://arxiv.org/pdf/2101.05494.pdf" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Slides" style="outline-dark" size="sm" %} 
...
<li><a target="_blank" href="https://github.com/jharkawat/meddoprof_shared_task">
          "Spanish Pre-Trained Language Models for HealthCare Industry"</a>, Tejas Vaidhya and Jalaj Harkawat<br>
           <b><u>Oral Presentation</u></b> at Proceedings of the Iberian Languages Evaluation Forum  <br> {% include elements/button.html link="https://github.com/jharkawat/meddoprof_shared_task" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Slides" style="outline-dark" size="sm" %} 
...
<li><a target="_blank" href="https://drive.google.com/file/d/1UDGujYmKUzDRFgLbvF355URmxiEyoMXv/view">
          ...
          <b><u>Long Paper</u></b> at the 2021 Conference on Emperical Methods in Natural Language Processing (EMNLP)<br>   {% include elements/button.html link="" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="https://drive.google.com/file/d/1UDGujYmKUzDRFgLbvF355URmxiEyoMXv/view" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Slides" style="outline-dark" size="sm" %}
...
<li><a target="_blank" href="https://drive.google.com/file/d/12-hJeIqjMx-GnfjXf3E6vcVYlamN5yoR/view?usp=sharing">
          ...
          <b><u>Findings of EMNLP</u></b> at the 2021 Conference on Emperical Methods in Natural Language Processing (EMNLP) <br>
             {% include elements/button.html link="" text="Code" style="outline-dark" size="sm" %} {% include elements/button.html link="https://drive.google.com/file/d/12-hJeIqjMx-GnfjXf3E6vcVYlamN5yoR/view?usp=sharing" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Slides" style="outline-dark" size="sm" %} 
...
<li><a target="_blank" href="https://drive.google.com/file/d/1ZczptNNnywiKzt_1tex6fbo-_7oEgZLT/view">
  ...
  {% include elements/button.html link="https://github.com/tejasvaidhyadev/ArP-GAN" text="Code" style="outline-dark" size="sm" %}  {% include elements/button.html link="https://drive.google.com/file/d/1ZczptNNnywiKzt_1tex6fbo-_7oEgZLT/view" text="Pdf" style="outline-dark" size="sm" %} {% include elements/button.html link="" text="Cite" style="outline-dark" size="sm" %} {% include elements/button.html link="https://indusfloorplan.web.app/home" text="Demo" style="outline-dark" size="sm" %} <br> <a style="float:right; color:#3491fe;" data-toggle="collapse" data-target="#pandu"><u>More</u> </a>
